...
const Info = () => {
    return (
        <div className='grid grid-cols lg:grid-cols-4 gap-5 mx-28 my-14'>

            <div className="card h-32 card-side bg-base-100 shadow-xl px-5">
                <figure><img className='' src={icon1} alt="Movie" /></figure>
            ...
            <div className="card h-32 card-side bg-base-100 shadow-xl px-5">
                <figure><img className='' src={icon2} alt="Movie" /></figure>
                <div className="card-body text-left">
            ...
            <div className="card h-32 card-side bg-base-100 shadow-xl px-5">
                <figure><img className='' src={icon3} alt="Movie" /></figure>
                <div className="card-body text-left">
            ...
            <div className="card h-32 card-side bg-base-100 shadow-xl px-5">
                <figure><img className='' src={icon4} alt="Movie" /></figure>
                <div className="card-body text-left">
